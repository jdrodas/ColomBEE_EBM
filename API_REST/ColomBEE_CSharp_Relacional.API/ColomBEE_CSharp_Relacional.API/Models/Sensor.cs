...
public class Sensor
{
    ...
    [JsonPropertyName("tipo_id")] public Guid TipoId { get; set; } = Guid.Empty;

    [JsonPropertyName("colmena_id")] public Guid ColmenaId { get; set; } = Guid.Empty;

    [JsonPropertyName("tipo_nombre")] public string? TipoNombre { get; set; } = string.Empty;

    [JsonPropertyName("colmena_codigo")] public string? ColmenaCodigo { get; set; } = string.Empty;
