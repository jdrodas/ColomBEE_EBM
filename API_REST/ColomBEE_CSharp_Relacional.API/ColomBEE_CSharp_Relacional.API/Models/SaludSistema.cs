...
public class SaludSistema
{
    ...
    [JsonPropertyName("fecha_validacion")] public DateTime FechaValidacion { get; set; } = DateTime.UtcNow;
    ...
    [JsonPropertyName("detalle_error")] public string DetalleError { get; set; } = string.Empty;
    ...
    [JsonPropertyName("tipo_validacion")] public string TipoValidacion { get; set; } = "SALUD";

    [JsonPropertyName("esta_saludable")] public bool EstaSaludable { get; set; } = false;
}